...
public class FansMgtController {
	...
	private static final Logger log = LoggerFactory
			.getLogger(FansMgtController.class);
	...
	public ResponseEntity<Void> createConnectionRequest(
		...
		headers.setLocation(uriComponentsBuilder.path(ApiConstants.URI_API_PUBLIC + ApiConstants.URI_FANS
...
//		}
//    	
//    	Page<ConnectionRequestsDetails> connectionRequestsDetails =this.fansService.findConnectionRequestsByMemberUser(id, page);
//    	
