...
public class FansMgtController {
    ...
    public ResponseEntity<Void> saveFans(@RequestBody FansForm form,
        ...
        headers.setLocation(uriComponentsBuilder.path(ApiConstants.URI_API_PUBLIC + ApiConstants.URI_FANS + "/{id}")
    ...
    //
    // return new ResponseEntity<>(new ResponseMessage(ResponseMessage.Type.success,
    // "add friend success"),
