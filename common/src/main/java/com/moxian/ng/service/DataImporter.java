...
public class DataImporter {
	...
	// = new Permission[]{
	// new Permission(Category.BANK, "PERM_VIEW_BANK_COLLECTION",
	// "^/api/mgt/banks(/?)(\\?.*)?$",
	// "GET", i++),
	// new Permission(Category.BANK, "PERM_ADD_BANK", "^/api/mgt/banks(/?)$",
	// "POST", i++),
	// new Permission(Category.BANK, "PERM_VIEW_BANK",
	// "^/api/mgt/banks/[\\d](/?)$", "GET", i++),
	// new Permission(Category.BANK, "PERM_EDIT_BANK",
	// "^/api/mgt/banks/[\\d](/?)$", "PUT", i++),
	// new Permission(Category.BANK, "PERM_ACTIVATE_BANK",
	// "^/api/mgt/banks/[\\d](/?)(\\?action=ACTIVATE)$", "PUT", i++),
	// new Permission(Category.BANK, "PERM_DEACTIVATE_BANK",
	// "^/api/mgt/banks/[\\d](/?)$", "DELETE",
	// i++)};
	//
	...
	// "^/api/mgt/posts(/?)(\\?.*)?$", "GET", i++),
	// new Permission(Category.CONTENT_POST, "PERM_ADD_POST",
	// "^/api/mgt/posts(/?)$", "POST", i++),
	// new Permission(Category.CONTENT_POST, "PERM_VIEW_POST",
	// "^/api/mgt/posts/[\\d](/?)$", "GET",
	// i++),
	...
	// new Permission(Category.CONTENT_POST, "PERM_EDIT_POST",
	// "^/api/mgt/posts/[\\d](/?)$", "PUT",
	// i++),
	// new Permission(Category.CONTENT_POST, "PERM_DEACTIVATE_POST",
	// "^/api/mgt/posts/[\\d](/?)$",
	// "DELETE", i++)};
	//
	// if (log.isDebugEnabled()) {
	...
	// new Permission(Category.BILL, "PERM_VIEW_BILL",
	// "^/api/mgt/bills(/?)(\\?.*)?$", "GET", i++),
	// new Permission(Category.BILL, "PERM_ADD_BILL", "^/api/mgt/bills(/?)$",
	// "POST", i++),
	// new Permission(Category.BILL, "PERM_EDIT_BILL", "^/api/mgt/bills(/?)$",
	// "PUT", i++),
	...
	// new Permission(Category.BILL, "PERM_ADD_BACKLOGITEM",
	// "^/api/mgt/backlogs(/?)$", "POST", i++), // new Permission(Category.BILL,
	// "PERM_RECOUNT_BACKLOGITEM",
	...
	// new Permission(Category.ACCOUNT, "PERM_ADD_ACCOUNT",
	// "^/api/mgt/accounts(/?)$", "POST", i++),
	// new Permission(Category.ACCOUNT, "PERM_VIEW_ACCOUNT",
	// "^/api/mgt/accounts/[\\d](/?)$", "GET",
	// i++),
	// new Permission(Category.ACCOUNT, "PERM_EDIT_ACCOUNT",
	// "^/api/mgt/accounts/[\\d](/?)$", "PUT",
	// i++),
	// new Permission(Category.ACCOUNT, "PERM_LOCK_ACCOUNT",
	// "^/api/mgt/accounts/[\\d](/?)$",
	// "DELETE", i++),
	// new Permission(Category.ACCOUNT, "PERM_UNLOCK_ACCOUNT",
	// "^/api/mgt/accounts/[\\d](/?)\\?action=UNLOCK$", "PUT", i++),
	// new Permission(Category.ACCOUNT, "PERM_VIEW_ROLE",
	// "^/api/mgt/roles(/?)(\\?.*)?$", "GET", i++),
	// new Permission(Category.ACCOUNT, "PERM_ADD_ROLE", "^/api/mgt/roles(/?)$",
	// "POST", i++),
	// new Permission(Category.ACCOUNT, "PERM_EDIT_ROLE",
	// "^/api/mgt/roles/[\\d](/?)$", "PUT", i++),
	// new Permission(Category.ACCOUNT, "PERM_LOCK_ROLE",
	// "^/api/mgt/roles/[\\d](/?)$", "DELETE", i++),
	...
	// new Permission(Category.ACCOUNT, "PERM_VIEW_PERMISSION",
	// "^/api/mgt/permissions/[\\d](/?)$",
	// "GET", i++),
	// new Permission(Category.ACCOUNT, "PERM_EDIT_PERMISSION",
	// "^/api/mgt/permissions/[\\d](/?)$",
	// "PUT", i++)
	//
	// };
	...
	// new Permission(Category.ACCOUNTING, "PERM_VIEW_ACCOUNTING",
	// "^/api/mgt/acct(/?)(\\?.*)$", "GET", i++),
	// new Permission(Category.ACCOUNTING, "PERM_ADD_BIDINFO",
	// "^/api/mgt/acct/addbidinfo(/?)$", "POST", i++),
	// new Permission(Category.ACCOUNTING, "PERM_UPDATE_TRANSACTION_LOG",
	// "^/api/mgt/acct/[\\d](/?)$", "PUT", i++),
	// new Permission(Category.ACCOUNTING, "PERM_VIEW_TRANSFER_LOGS",
	// "^/api/mgt/acct/transfer(/?)(\\?.*)$", "GET", i++),
	// new Permission(Category.ACCOUNTING, "PERM_TRANSFER",
	// "^/api/mgt/acct/transfer(/?)$", "POST", i++),
	// new Permission(Category.ACCOUNTING, "PERM_VIEW_RECONCILIATIONS",
	// "^/api/mgt/acct/reconciliations(/?)(\\?.*)$", "GET", i++),};
	//
	// if (log.isDebugEnabled()) {
	...
	//
	// Permission[] permissions = new Permission[]{
	// new Permission(Category.CONFIG, "PERM_VIEW_CONF", "^/api/mgt/conf(/?)$",
	// "GET", i++),
	// new Permission(Category.CONFIG, "PERM_UPDATE_CONF",
	// "^/api/mgt/conf(/?)$", "PUT", i++),
	// new Permission(Category.CONFIG, "PERM_VIEW_APPUPDATE_COLLECTION",
	// "^/api/mgt/appupdates(/?)(\\?.*)?$", "GET", i++),
	// new Permission(Category.CONFIG, "PERM_ADD_APPUPDATE",
	// "^/api/mgt/appupdates(/?)$", "POST", i++),
	// new Permission(Category.CONFIG, "PERM_EDIT_APPUPDATE",
	// "^/api/mgt/appupdates(/?)$", "PUT", i++)
	// };
	//
	// if (log.isDebugEnabled()) {
	...
	// Permission[] permissions
	// = new Permission[]{
	// new Permission(Category.USER, "PERM_VIEW_USER_COLLECTION",
	// "^/api/mgt/users(/?)(\\?.*)?$",
	// "GET", i++),
	// new Permission(Category.USER, "PERM_ADD_USER", "^/api/mgt/users(/?)$",
	// "POST", i++),
	// new Permission(Category.USER, "PERM_VIEW_USER",
	// "^/api/mgt/users/[\\d](/?)(\\?.*)?$", "GET",
	// i++),
	// // new Permission(Category.USER, "PERM_VIEW_USER_PROFILE",
	// // "^/api/mgt/users/[\\d]/profile(/?)$", "GET", i++),
	// new Permission(Category.USER, "PERM_EDIT_USER",
	// "^/api/mgt/users/[\\d](/?)$", "PUT", i++),
	// new Permission(Category.USER, "PERM_DEACTIVATE_USER",
	// "^/api/mgt/users/[\\d](/?)$", "DELETE",
	// i++),
	// new Permission(Category.USER, "PERM_ACTIVATE_USER",
	// "^/api/mgt/users/[\\d](/?)\\?action=ACTIVATE$", "PUT", i++),
	// new Permission(Category.USER, "PERM_LOCK_USER",
	// "^/api/mgt/users/[\\d](/?)\\?action=LOCK$",
	// "PUT", i++),
	// new Permission(Category.USER, "PERM_UNLOCK_USER",
	// "^/api/mgt/users/[\\d](/?)\\?action=UNLOCK$",
	// "PUT", i++)
	// };
	//
	// if (log.isDebugEnabled()) {
	...
	// new Permission(Category.ENTERPRISE, "PERM_ADD_ENTERPRISE",
	// "^/api/mgt/enterprises(/?)$",
	// "POST", i++),
	// new Permission(Category.ENTERPRISE, "PERM_VIEW_ENTERPRISE",
	// "^/api/mgt/enterprises/[\\d](/?)$",
	// "GET", i++),
	// new Permission(Category.ENTERPRISE, "PERM_EDIT_ENTERPRISE",
	// "^/api/mgt/enterprises/[\\d](/?)$",
	// "PUT", i++),
	...
	// new Permission(Category.PRODUCT, "PERM_ADD_PRODUCT",
	// "^/api/mgt/products(/?)$", "POST", i++),
	// new Permission(Category.PRODUCT, "PERM_VIEW_PRODUCT",
	// "^/api/mgt/products/[\\d](/?)$", "GET",
	// i++),
	// new Permission(Category.PRODUCT, "PERM_EDIT_PRODUCT",
	// "^/api/mgt/products/[\\d](/?)$", "PUT",
	// i++),
	// new Permission(Category.PRODUCT, "PERM_DELETE_PRODUCT",
	// "^/api/mgt/products/[\\d](/?)$",
	// "DELETE", i++),
	// new Permission(Category.PRODUCT, "PERM_APPLY_PRODUCT",
	// "^/api/mgt/products/[\\d](/?)$", "POST",
	// i++),
	...
	// Permission[] permissions
	// = new Permission[]{
	// new Permission(Category.ORDER, "PERM_VIEW_ORDER_COLLECTION",
	// "^/api/mgt/orders/search(/?)(\\?.*)?$",
	// "POST", i++),
	// new Permission(Category.ORDER, "PERM_VIEW_ORDER",
	// "^/api/mgt/orders/[\\d](/?)(\\?.*)?$", "GET",
	// i++),
	// new Permission(Category.ORDER, "PERM_REPAY_ORDER",
	// "^/api/mgt/orders/[\\d](/?)?action=REQUEST_REPAYMENT$", "PUT",
	// i++),
	// new Permission(Category.ORDER, "PERM_DEACTIVATE_ORDER",
	// "^/api/mgt/orders/[\\d](/?)?action=DEACTIVATE$", "PUT",
	// i++),
	...
	// Permission[] permissions
	// = new Permission[]{
	// new Permission(Category.REPORT, "PERM_VIEW_REPORT",
	// "^/api/mgt/reports/(.*)(\\?.*)?$",
	// "GET", i++),};
	//
	// if (log.isDebugEnabled()) {
	...
	private void loadReservedUserData() {
		...
		Role[] roles = new Role[] { new Role(Role.ROLE_ADMIN),
		...
		UserAccount userAccount = new UserAccount("admin",
				passwordEncoder.encode("test123"), "Administrator", false,
				UserAccount.Type.STAFF, "ADMIN");

		UserAccount userAccount2 = new UserAccount("test001",
				passwordEncoder.encode("test123"), "test001", false,
				UserAccount.Type.STAFF, "ADMIN");
		UserAccount userAccount3 = new UserAccount("test002",
				passwordEncoder.encode("test123"), "test002", false,
				UserAccount.Type.STAFF, "ADMIN");

		UserAccount userAccount4 = new UserAccount("test003",
				passwordEncoder.encode("test123"), "test002", false,
				UserAccount.Type.STAFF, "ADMIN");

		UserAccount userAccount5 = new UserAccount("test004",
				passwordEncoder.encode("test123"), "test002", false,
				UserAccount.Type.STAFF, "ADMIN");

		UserAccount userAccount6 = new UserAccount("test005",
				passwordEncoder.encode("test123"), "test002", false,
				UserAccount.Type.STAFF, "ADMIN");

		UserAccount userAccount7 = new UserAccount("test006",
				passwordEncoder.encode("test123"), "test002", false,
				UserAccount.Type.STAFF, "ADMIN");
		...
		fans.setFollowingUser(saved2);
		fans.setMemberUser(saved1);

		Fans fans1 = new Fans();
		fans1.setActive(true);
		fans1.setCreateOn(LocalDateTime.now());
		fans1.setFollowingUser(saved1);
		fans1.setMemberUser(saved2);

		Fans fans2 = new Fans();
		fans2.setActive(true);
		fans2.setCreateOn(LocalDateTime.now());
		fans2.setFollowingUser(saved3);
		fans2.setMemberUser(saved1);

		Fans fans3 = new Fans();
		fans3.setActive(true);
		fans3.setCreateOn(LocalDateTime.now());
		fans3.setFollowingUser(saved1);
		fans3.setMemberUser(saved3);

		Fans fans4 = new Fans();
		fans4.setActive(true);
		fans4.setCreateOn(LocalDateTime.now());
		fans4.setFollowingUser(saved4);
		fans4.setMemberUser(saved1);

		Fans fans5 = new Fans();
		fans5.setActive(true);
		fans5.setCreateOn(LocalDateTime.now());
		fans5.setFollowingUser(saved1);
		fans5.setMemberUser(saved4);

		Fans fans6 = new Fans();
		fans6.setActive(true);
		fans6.setCreateOn(LocalDateTime.now());
		fans6.setFollowingUser(saved5);
		fans6.setMemberUser(saved1);

		Fans fans7 = new Fans();
		fans7.setActive(true);
		fans7.setCreateOn(LocalDateTime.now());
		fans7.setFollowingUser(saved1);
		fans7.setMemberUser(saved5);

		Fans fans8 = new Fans();
		fans8.setActive(true);
		fans8.setCreateOn(LocalDateTime.now());
		fans8.setFollowingUser(saved5);
		fans8.setMemberUser(saved6);

		Fans fans9 = new Fans();
		fans9.setActive(true);
		fans9.setCreateOn(LocalDateTime.now());
		fans9.setFollowingUser(saved6);
		fans9.setMemberUser(saved7);
	...
	private void createFansIfAbsent(Fans fans) {
		...
		Fans existedFans = this.fansRepository.findFansBySendAndRecept(fans
				.getFollowingUser().getId(), fans.getMemberUser().getId());
		if (existedFans == null) {
	...
	private Group createGroupIfAbsent(Group group) {
		final Group existedGroup = this.groupRepository.findGroupByName(group
				.getName());
	...
	private Connections createConnectionsIfAbsent(Connections connections) {
		final Connections existedConnections = this.connectionsRepository
				.findConnectionByConnectedUserAndMemberUser(connections
						.getConnectedUser().getId(), connections
						.getMemberUser().getId());
		if (existedConnections == null) {
			Connections connectionsSave = this.connectionsRepository
					.save(connections);
	...
	private UserAccount createUserAccountIfAbsent(UserAccount user) {
		final UserAccount existedUserAccount = this.userRepository
	...
	//
	// GrantedPermission grantedPermission = new GrantedPermission("TEST",
	// "PERM_VIEW_BANK");
	// GrantedPermission grantedPermission2 = new GrantedPermission("TEST",
	// "PERM_ADD_BANK");
	//
	...
	// = new UserAccount("test1", passwordEncoder.encode("test123"),
	// "Test User 1", false,
	// UserAccount.Type.STAFF, "USER");
	// UserAccount userAccount2
	// = new UserAccount("test2", passwordEncoder.encode("test123"),
	// "Test User 2", false,
	// UserAccount.Type.STAFF, "TEST");
	//
	// UserAccount grandz
	// = new UserAccount("grandzh", passwordEncoder.encode("grandzh@123"),
	// "Grand Zhang", false,
	// UserAccount.Type.USER, "USER");
	//
	// UserAccount roy
	// = new UserAccount("roy", passwordEncoder.encode("test123"), "Roy Yang",
	// false,
	// UserAccount.Type.ENTERPRISE, "USER");
	// AccountingInfo accountingInfo1 = new AccountingInfo("ycy_alibabaworld",
	// "6000060000806249");
	...
	//
	// UserAccount yang
	// = new UserAccount("yang", passwordEncoder.encode("test123"), "Yang Kui",
	// false,
	// UserAccount.Type.ENTERPRISE, "USER");
	// AccountingInfo accountingInfo2 = new AccountingInfo("ycy_microsoftworld",
	// "6000060000806258");
	...
	// UserAccount saved2 = createUserAccountIfAbsent(userAccount2);
	//
	// AccountingInfo zhangAccountingInfo = new AccountingInfo("1",
	// "6000060000757435");
	...
	// = new UserAccount("appTest", passwordEncoder.encode("123456"), "appTest",
	// false,
	// UserAccount.Type.USER, "USER");
	// appTestAccount.setEmail("appTestAccount");
	// appTestAccount.setIdCardVerification(new IdCardVerification("阿呆发",
	// "430423198108255881"));
	//
	// AccountingInfo appTestAccountingInfo = new AccountingInfo("ycy_appTest",
	// "6000060000827440");
	// appTestAccount.setAccountingInfo(appTestAccountingInfo);
	// UserAccount appTestAccountSaved =
	// createUserAccountIfAbsent(appTestAccount);
	//
	...
	//
	// StaffProfile staffProfile = new StaffProfile("IT", "", "", "",
	// savedTestUser1);
	...
	// = new Enterprise("alibaba", "001", "13472858302", "02188889999", "00100",
	// "", "上海银行", "", "", "", "", "",
	// Enterprise.Type.PERNAS, "", "430621199908147715", "02111112222",
	// "yangkuimsg@hotmail.com",
	...
	// = new Enterprise("microsoft", "002", "18572858302", "02188889999",
	// "00200", "", "上海建设银行", "", "", "", "",
	// "", Enterprise.Type.PERNAS, "", "430621199908147715", "02111112222",
	// "yangkuimsg@hotmail.com",
	...
	private UserProfile createUserProfileIfAbsent(UserProfile profile) {
		...
		final UserProfile existedProfile = userProfileRepository
				.findByAccountId(profile.getAccount().getId());
	...
	// private BankCardInfo createBankCardInfoIfAbsent(BankCardInfo
	// bankCardInfo) {
	// if (log.isDebugEnabled()) {
	// log.debug("findByUserIdAndCardId @ userId  {}  openAccId  {}",
	// bankCardInfo.getUser().getId(), bankCardInfo.getCardId());
	// }
	// final BankCardInfo existedBankCardInfo =
	// bankCardInfoRepository.findByUserIdAndCardId(bankCardInfo.getUser().getId(),
	// bankCardInfo.getCardId());
	...
	// final PurchaseOrder orderFindBySerialNumber =
	// orderRepository.findBySerialNumber(order.getSerialNumber());
	...
	private void createGrantedPermissionIfAbsent(
			GrantedPermission grantedPermission) {
		if (this.grantedPermissionRepository.findByRoleAndPermission(
				grantedPermission.getRole(), grantedPermission.getPermission()) == null) {
			grantedPermissionRepository.save(grantedPermission);
		}
	}

	// private Bank createBankIfAbsent(Bank bank) {
	// final Bank bankFindByName =
	// this.bankRepository.findByName(bank.getName());
	...
	// final Enterprise entFindByName =
	// this.enterpriseRepository.findByName(enterprise.getName());
	...
	// final Bill billFindBySerialNumber =
	// this.billRepository.findBySerialNumber(bill.getSerialNumber());
	...
	// UserAccount userAccount2 = new UserAccount("test3",
	...
	private void initialzePostDatas() {
		...
		populator.addScript(resourceLoader
				.getResource("classpath:/post_data.sql"));
